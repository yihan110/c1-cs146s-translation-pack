...
| 拿说明 | `06_deliverables/拿说明1~3.md` | 三个关键产出的「怎么做出来」演示 |
| 发布步骤 | `06_deliverables/发布步骤.md` | 本地 zip / GitHub 发布说明（不翻墙、可选） |
| 质量报告 | `05_quality/*.json` | 术语一致性检查 + 覆盖度统计 |

## 二、来源与完整性

- **原始资料**：`materials/CS146S_offline.zip`（Stanford CS146S 2025 秋离线缓存：**31 篇 HTML 讲义 + 3 份 PDF + 课程主页 + 站点资源**）与 `materials/Vibe_Coding_Playbook.pdf`。
